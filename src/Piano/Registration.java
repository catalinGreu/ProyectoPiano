...
public class Registration extends JFrame {
	...
	public Registration() {
		...
		lblNewLabel.setIcon(new ImageIcon(Registration.class.getResource("/Piano/registroVerde.png")));
		lblNewLabel.setBounds(115, 11, 366, 87);
...
//					e.printStackTrace();
		...
		lblConfirmacion.setBounds(509, 342, 61, 36);
...
//		piano.setUserConected(u.getIDUser(), true );
//		try {
//			piano.setEntityManager(em);
//		} catch (Exception ex) {
//			// TODO Auto-generated catch block
//			ex.printStackTrace();
//		}
